...
class PreviousRecordingsScreen(Toplevel): 
    ...
    def apply(self):
        self.calculateDate()
        previousRecordingsFile = open("testPreviousRecordings.txt","r")
		# change filename when before actual file is created
	previousRecordingsList = previousRecordingsFile.readlines()
	previousRecordingsFile.close()
        listOfEvents = []
